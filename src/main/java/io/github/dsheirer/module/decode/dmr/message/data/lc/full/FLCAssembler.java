...
public class FLCAssembler
{
    ...
    {
        FullLCMessage message = decode(mAssemblingMessage, mTimestamp, mTimeslot);
    ...
    private static FullLCMessage decode(BinaryMessage message, long timestamp, int timeslot)
    {
        if(message != null)
        {
            ...
            FullLCMessage flco = LCMessageFactory.createFull(extractedMessage, timestamp, timeslot);
            flco.setValid(valid);
            return flco;
        }
