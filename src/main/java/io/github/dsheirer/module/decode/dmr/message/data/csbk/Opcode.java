...
public enum Opcode
{
    ...
    MOTOROLA_CONPLUS_VOICE_CHANNEL_GRANT(Vendor.MOTOROLA_CONNECT_PLUS, 3, "VOICE CHANNEL GRANT"),
    ...
    //Opcode 28: seems to be a 'Channel In Use' message.  Not sure what the counter field represents.
    MOTOROLA_CONPLUS_CHANNEL_ACTIVE(Vendor.MOTOROLA_CONNECT_PLUS, 28, "CHANNEL ACTIVE"),
    MOTOROLA_CONPLUS_CHANNEL_USER(Vendor.MOTOROLA_CONNECT_PLUS, 29, "CHANNEL USER"),
    //9D064D260E00E08000208C5D just before radio 4D260E was receiving data packets

    MOTOROLA_CAPPLUS_ALOHA(Vendor.MOTOROLA_CAPACITY_PLUS, 25, "ALOHA"),
    ...
    MOTOROLA_CAPPLUS_UNK_41(Vendor.MOTOROLA_CAPACITY_PLUS, 41, "UNK 41"),
    MOTOROLA_CAPPLUS_UNK_42(Vendor.MOTOROLA_CAPACITY_PLUS, 42, "UNK 42"),
