...
public class MoveTSCC extends CSBKMessage
{
    ...
    public String toString()
    {
        ...
        sb.append(" MOVE TRUNK CONTROL CHANNEL ").append(getDMRChannel());
    ...
    public DMRChannel getDMRChannel()
    {
        if(mDMRChannel == null)
        {
            mDMRChannel = new DMRLogicalChannel(getMessage().getInt(CHANNEL_NUMBER));
        }
    ...
    public List<Identifier> getIdentifiers()
    {
        if(mIdentifiers == null)
        {
            ...
            mIdentifiers.add(getDMRChannel());
        }
