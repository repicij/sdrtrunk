 ...
 */
public class CapacityPlusAloha extends CSBKMessage
{
     ...
     * @param timeslot
     */
    public CapacityPlusAloha(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
