...
/**
 * Motorola Connect Plus - Voice Channel Grant
 */
public class ConnectPlusVoiceChannelGrant extends CSBKMessage implements ITimeslotFrequencyReceiver
{
     ...
     * @param timeslot
     */
    public ConnectPlusVoiceChannelGrant(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
